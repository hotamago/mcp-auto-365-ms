...
echo " Server name: auto-365-ms (All 11 tools in 1 process)  "
...
echo "  5. send_teams_message (Message Dispatch)              "
echo "  6. edit_teams_message (Edit Sent Message)             "
echo "  7. delete_teams_message (Delete Sent Message)         "
echo "  8. download_chat_attachments (Auto-dl from Chat)      "
echo "  9. read_teams_chat                                    "
echo " 10. list_teams_chats                                   "
echo " 11. search_teams_chat_messages                         "
echo "========================================================"
