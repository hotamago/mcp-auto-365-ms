...
echo " Server name: auto-365-ms (All 13 tools in 1 process)  "
...
echo "  5. get_recent_team_messages (1-Step Team Feed)        "
echo "  6. get_my_mentions (Tasks & Mentions for You)         "
echo "  7. send_teams_message (Message Dispatch)              "
echo "  8. edit_teams_message (Edit Sent Message)             "
echo "  9. delete_teams_message (Delete Sent Message)         "
echo " 10. download_chat_attachments (Auto-dl from Chat)      "
echo " 11. read_teams_chat                                    "
echo " 12. list_teams_chats                                   "
echo " 13. search_teams_chat_messages                         "
echo "========================================================"
