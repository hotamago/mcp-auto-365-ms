...
echo " Server name: auto-365-ms (All 15 tools in 1 process)  "
...
echo "  6. get_daily_briefing (Executive Morning Briefing)    "
echo "  7. get_recent_team_messages (1-Step Team Feed)        "
echo "  8. get_my_mentions (Tasks & Contextual Mentions)      "
echo "  9. send_teams_message (Send / Quote-Reply / Attach)   "
echo " 10. edit_teams_message (Edit Sent Message)             "
echo " 11. delete_teams_message (Delete Sent Message)         "
echo " 12. download_chat_attachments (Auto-dl from Chat)      "
echo " 13. read_teams_chat                                    "
echo " 14. list_teams_chats                                   "
echo " 15. search_teams_chat_messages                         "
echo "========================================================"
